...
# Session 3.1: Data Management

**Date:** Tuesday, August 4, 2026
**Time:** 8:30 AM - 12:00 PM Pacific
...
COMPrehensive Learning for end-users to Effectively utilize CyberinfraStructure ([COMPLECS](https://www.sdsc.edu/education/training-programs/COMPLECS.html)) is a training program offered by the [San Diego Supercomputer Center](https://www.sdsc.edu) that covers the most important non-programming concepts and skills that you need to effectively use supercomputers. Topics include parallel computing concepts, Linux tools and bash scripting, security, batch and interactive computing, how to get help, and data management.
